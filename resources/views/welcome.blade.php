                ...
                <div class="position-sticky pt-3">
                    <div>
                        <a href="/" class="d-flex align-items-center text-white text-decoration-none"
                            id="dropdownUser1">
                            <img src="/rezki.jpg" alt="" width="32" height="32"
                    ...
                    <ul class="nav nav-pills flex-column nav-pills">
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $title === 'Home' ? 'active' : '' }}" aria-current="page"
                                href="/">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $title === 'Orders' ? 'active' : '' }}" href="/Orders">
                                <span data-feather="file" class="align-text-bottom"></span>
                                Pesanan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $title === 'Products' ? 'active' : '' }}" href="/Products">
                                <span data-feather="shopping-cart" class="align-text-bottom"></span>
                                Produk
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $title === 'Vendor' ? 'active' : '' }}" href="/Vendor">
                                <span data-feather="users" class="align-text-bottom"></span>
                                Vendor
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $title === 'Reports' ? 'active' : '' }}" href="/Reports">
                                <span data-feather="bar-chart-2" class="align-text-bottom"></span>
                                Laporan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $title === 'Employees' ? 'active' : '' }}"
                                href="/Employees">
